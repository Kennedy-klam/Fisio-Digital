...
<head>
    ...
    <title>Tela da Administração</title> 
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <span class="text">Painel da Administração</span>
                </div>
                ...
                <div class="boxes">
                    ...
                    <a href="nova-consulta/book0.5.php" class="box box2">
                        <i class="fas fa-comments"></i>
                        <span class="text">Nova Consulta</span>
                    </a>
                    <a href="consultas-marcadas/viewappointment.php" class="box box3">
...
?>
            <div class="activity">
                <div class="title">
                    ...
                    <span class="text">Olá, <?php echo $admnome ?>!</span>
                </div>
